...
export enum UserRole {
  ADMIN = 'ADMIN',   // Diretor / Gestor
  TEACHER = 'TEACHER', // Professor
  PARENT = 'PARENT',   // Pai, Mãe ou Responsável
  STUDENT = 'STUDENT'  // Aluno / Filho
}

// Added School interface to resolve import error in App.tsx
...
export interface SchoolClass {
  ...
  grade: number; // 1 a 5
  // Fixed: Added schoolId property to match usage in App.tsx line 1711
  schoolId: string;
}
...
export type ViewState = 
  ...
  | 'DASHBOARD_STUDENT'
  | 'MANAGE_SCHOOLS' // Added missing view state for consistency
  | 'MANAGE_USERS'
  | 'ENROLL_STUDENT'
  | 'MANAGE_CLASSES' 
  | 'CREATE_QUIZ'
